...
function ci_tm4c123_setup {
    ...
    wget -O ./tivaware.exe https://software-dl.ti.com/tiva-c/SW-TM4C/2.2.0.295/exports/SW-EK-TM4C123GXL-2.2.0.295.exe
    unzip -d ports/tm4c123/tivaware tivaware.exe 
}
